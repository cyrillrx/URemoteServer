...
const std::string TextKey::XC_UNKNOWN_SECURITY_TOKEN = "xc_unknown_security_token";
const std::string TextKey::XC_TEST			= "xc_test";
const std::string TextKey::XC_PC_SHUTDOWN	= "xc_pc_shutdown";
