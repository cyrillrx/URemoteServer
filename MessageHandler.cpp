...
MessageHandler* MessageHandler::s_MessageManager = NULL; 
...
string MessageHandler::TreatCommand(string _cmd) 
{
...
string MessageHandler::VolumeCommand(string _param)
{
	ostringstream reply;
...
string MessageHandler::ClassicCommand(string _param)
{
	ostringstream reply;
...
MessageHandler* MessageHandler::GetInstance() {
	if (!s_MessageManager) {
		s_MessageManager = new MessageHandler();
	}
